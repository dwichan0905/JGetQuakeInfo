...
private frmDebug frmDebug;
    ...
    public frmInfo() {
        ...
        initComponents();
        //loadInfo();
        //MenghilanglahWahaiJendelaku();
    }
    
    public void MenghilanglahWahaiJendelaku() {
        try {
            ...
            prop.load(in);
            // read property first!
            int time = Integer.parseInt(prop.getProperty("hideinfo"));
...
//            
//            this.setTitle("NEW: " + tgljam + " at " + wil);
//            
//            in.close();
//        } catch (IOException ex) {
